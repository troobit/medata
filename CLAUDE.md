...
- OS floor: iOS 17 / macOS 14. **Hardware floor: iPhone 16 Pro** (2026-07-15; the 13 Pro Max and older are out of scope — segmenter-foundation Decision 22). Primary device: iPhone 16 Pro (devicectl id `6AD781BA-89FF-5A82-A2A1-B5EC9469F465`, name `you`); non-LiDAR fallback is two-view capture + ID-1 card for scale (audience unclear now all in-scope devices have LiDAR — descope decision pending).
