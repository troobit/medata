...
// Source: GeomSubconfidences.proto
//
...
public struct PbGeomSubconfidences: Sendable {
...
extension PbGeomSubconfidences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.sigmaView.bitPattern != 0 {
      try visitor.visitSingularFloatField(value: self.sigmaView, fieldNumber: 1)
    }
    if self.sigmaPlane.bitPattern != 0 {
      try visitor.visitSingularFloatField(value: self.sigmaPlane, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: PbGeomSubconfidences, rhs: PbGeomSubconfidences) -> Bool {
