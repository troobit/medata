...
| 8 | Tab bar visible on all tabs (layout invariant in MASTER.md) | No tab bar anywhere; single-cover shell | [Decision 12](../../../specs/ui/design-handoff-00/decision_log.md#decision-12-mastermd-amendments--no-palette-swap-two-new-tokens-tab-bar-invariant-deleted) — MASTER.md tab-bar invariant deleted |
...
| 10 | History / Settings / Trends present as sheets over Capture | Full-screen covers with explicit close controls | [Decision 19](../../../specs/ui/design-handoff-00/decision_log.md#decision-19-data--trends--settings-present-as-full-screens-not-sheets) — user direction after seeing the implementation |
| 11 | Single `NavigationStack` rooted on Capture; app launches into the camera | Graph is the launch root; Capture / Data / Settings present as covers from Graph, AR session runs only while Capture is frontmost | [Decision 20](../../../specs/ui/design-handoff-00/decision_log.md#decision-20-graph-is-the-launch-root-capture-becomes-a-presented-surface) — user direction; camera-first launch was unwanted in developer use |
| 12 | Screen named `Trends`; read-only glucose footer; reassurance copy (correction preservation notice, import explainer) | Screen named `Graph` everywhere; all reassurance/disclaimer copy removed while the app is developer-only | [Decision 21](../../../specs/ui/design-handoff-00/decision_log.md#decision-21-trends-renamed-graph-developer-phase-copy-rule-bans-disclaimer-messaging) / Req 14.5 — standing project rule, recorded in CLAUDE.md |
