...
- [ ] 1. iPhone-only device family eliminates iPad orientation and icon warnings <!-- id:tuly0qn -->
...
- [ ] 2. `defaultCaptureModeReader` is `nonisolated` and the file-scope comment explains why <!-- id:tuly0qo -->
...
- [ ] 3. `MealRow.loadThumbnail` uses the connected window scene instead of `UIScreen.main` <!-- id:tuly0qp -->
...
- [ ] 4. Zero-warning, zero-error build confirmed for Debug and Release <!-- id:tuly0qq -->
  ...
  - Blocked-by: tuly0qn (Task 1), tuly0qo (Task 2), tuly0qp (Task 3)
