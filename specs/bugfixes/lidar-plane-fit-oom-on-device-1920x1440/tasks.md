...
- [x] 3. On-device verification on iPhone 13 Pro Max captures a clean run and `report.md` is finalised with the device log <!-- id:oom-004 -->
  ...
  - CLOSED 2026-08-11, retargeted to the iPhone 16 Pro per user directive; bread plate stands in for the fruit plate (the load is the candidate/inlier count, not the food). Outcome-store evidence in report.md: 1,055,573 candidates / 383,543 inliers refined in-place with a 2.12 mm residual, no allocation failure across 15 attempts.
