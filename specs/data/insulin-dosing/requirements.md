...
- **No notifications, timers, scheduled follow-up doses, or extended/square-wave boluses.** There is no scheduling surface in the app today and none is added here.
...
7. <a name="12.7"></a>The system SHALL NOT prompt, remind, nudge, or notify the developer to take a basal dose, and SHALL NOT display an adherence figure, streak, or missed-dose indicator.
