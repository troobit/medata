...
- [ ] 1. Review auth branch changes at `/Users/ronan/repos/beetus/auth`
- [ ] 2. Identify non-conflicting changes from auth
- [ ] 3. Merge auth branch into dev-0
- [ ] 4. Resolve any conflicts from auth merge
- [ ] 5. Verify: auth changes integrated cleanly
...
- [ ] 11. Review existing documentation for accuracy post-merge
- [ ] 12. Update outdated documentation to reflect current setup
- [ ] 13. Verify: Documentation matches current setup
