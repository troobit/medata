...
- [x] 7. Write CrossDatasetSkew TOST tests <!-- id:fjp41xc -->
...
- [x] 8. Implement HarnessCore/CrossDatasetSkew.swift <!-- id:fjp41xd -->
  - Blocked-by: fjp41xc (Write CrossDatasetSkew TOST tests)
  - Stream: 2
  - Requirements: [5.2](requirements.md#5.2)

- [x] 9. Write VolumeFitDiagnostic tests <!-- id:fjp41xe -->
  - beta_geom = V_mesh_true / V_est aggregated per class from metafood3d_truth.json
  - reported, not baked
  - Stream: 2
  - Requirements: [2.3](requirements.md#2.3)

- [x] 10. Implement HarnessCore/VolumeFitDiagnostic.swift <!-- id:fjp41xf -->
  - Blocked-by: fjp41xe (Write VolumeFitDiagnostic tests)
  - Stream: 2
  - Requirements: [2.3](requirements.md#2.3)

- [x] 11. Add CalibrationArtifact schema fields with serialization round-trip test <!-- id:fjp41xg -->
...
- [x] 12. Write CalibrateRun injected-plane branch tests incl. steep food <!-- id:fjp41xh -->
...
- [x] 13. Implement CalibrateRun MetaFood3D injected-plane branch <!-- id:fjp41xi -->
...
- [x] 14. Write single-class mixture-fit + effective-sample/SE verification test <!-- id:fjp41xj -->
...
- [x] 15. Write CalibrationMerge corroboration + skew tests <!-- id:fjp41xk -->
...
- [x] 16. Implement CalibrationMerge corroboration + skew wiring <!-- id:fjp41xl -->
...
- [x] 17. Write AccuracyHarness reporting tests <!-- id:fjp41xm -->
...
- [x] 18. Implement AccuracyHarness additions <!-- id:fjp41xn -->
...
- [x] 19. Wire HarnessCLI/main.swift for multi-dataset calibrate <!-- id:fjp41xo -->
...
- [x] 22. Write backwards-compat golden test <!-- id:fjp41xr -->
