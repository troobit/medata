...
1. <a name="4.1"></a>The process SHALL export `build/checkpoint.pt` to `MedataCore/Resources/segmenter.mlpackage` via `tools/segmenter/export.py` with FP16 weights.  
