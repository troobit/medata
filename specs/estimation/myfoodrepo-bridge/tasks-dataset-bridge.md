...
- [x] 1. Acquire the bridge dataset with SOURCE.md provenance <!-- id:vbs7lh4 -->
  ...
  - Resolved 2026-07-26 with a user-supplied Kaggle API token; SOURCE.md written with SHA-256 + counts (release 2.0: 39,962 train / 1,000 val / 498 categories)
...
- [x] 2. Publish the source-category to 36-channel coverage audit <!-- id:vbs7lh5 -->
  ...
  - Blocked-by: vbs7lh4 (Acquire the bridge dataset with SOURCE.md provenance)
...
- [x] 6. Update dataset docs for the new corpus <!-- id:vbs7lh9 -->
  ...
  - make spell green
  - Blocked-by: vbs7lh8 (Produce the merged FoodSeg103 + Food-Recognition-2022 corpus with frozen-seed splits)
