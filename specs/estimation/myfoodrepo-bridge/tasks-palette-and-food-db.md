...
- [ ] 1. Add cereal class to ClassPalette as index 24, bump version to v2 <!-- id:zcnu90o -->
...
- [ ] 2. Migrate persisted meal data v1 to v2 via PaletteMigrator <!-- id:zcnu90p -->
...
- [ ] 3. Add cereal FOOD_DATA row with CoFID composition and density <!-- id:zcnu90q -->
...
- [ ] 4. Regenerate both sqlite DBs under the bake lock and update food_db tests <!-- id:zcnu90r -->
...
- [ ] 5. Record palette v2 + cereal decision entry in specs/DECISIONS.md <!-- id:zcnu90s -->
...
- [ ] 6. Context quality gates green <!-- id:zcnu90t -->
