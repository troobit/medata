...
- [x] 21. Write failing pytest for the external co-occurrence stats builder <!-- id:isuh2qc -->
  - Output: co_stats shape + source field, split_seed null, palette coverage list, ingredient-mapping SHA-256
...
- [x] 22. Implement build_external_co_stats.py and the loss_config acceptance amendment <!-- id:isuh2qd -->
  - Committed ingredient_mapping_recipe1m.json (reviewable, like class_mapping_foodseg103.json)
