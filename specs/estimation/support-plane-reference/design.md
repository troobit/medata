...
| Depth grid ≠ 256×192 (N5k identity grid) | mm-based radii transfer (Req 5.1) — measured at ≤ 1 mm across a 2× halving, with `minAcceptedExtentPx` the one bar that does **not** transfer (Decision 35) |
