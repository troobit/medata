...
**Version:** 0.2
**Date:** 2026-06-13
**Status:** Draft (review-1 fixes applied)
...
5. <a name="4.5"></a>`event=estimate.start` SHALL log the food-region coverage value alongside the existing `capturePath` field so the corrected signal is captured in device traces.
