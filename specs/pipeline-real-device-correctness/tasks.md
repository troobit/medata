...
- [x] 11. Implement PreShutterSegmenter with separate CoreMLSegmenter, off-actor conversion, pause/awaitPaused, and pre-shutter logging <!-- id:81wvfj0 -->
  ...
  - Blocked-by: 81wvfiz (Write tests for PreShutterSegmenter (latest-wins, awaitPaused drain, MaskBox identity, cadence violation log)), cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, cadence, 81wvfiu (Implement StubInferenceEngine centred-ellipse predicate)
  - Stream: 1
...
- [ ] 16. Delete CentreRectangleMask.swift and verify regression sentinel still passes <!-- id:81wvfj5 -->
  ...
  - Blocked-by: 81wvfj4 (Write integration test for mask routing (Req 8.7)), routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing, routing
  - Stream: 1
