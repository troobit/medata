...
- [ ] 8. Write tests for VisionCardDetector synthetic ID-1 detection and corner order <!-- id:81wvfix -->
...
- [ ] 9. Implement VisionCardDetector with warmup() and carddetect.end logging <!-- id:81wvfiy -->
...
- [ ] 15. Write integration test for mask routing (Req 8.7) <!-- id:81wvfj4 -->
