...
- [ ] 1. Write failing generator tests for solid_servings <!-- id:v9970ip -->
...
- [ ] 2. Implement solid_servings in generate.py and regenerate committed DBs <!-- id:v9970iq -->
...
- [ ] 3. Write failing Foods test for the serving lookup <!-- id:v9970ir -->
  - Executed MedataCore suite: potato_boiled resolves to (unit, grams, step); water (liquid) returns nil

- [ ] 4. Implement FoodDatabase solid-serving lookup <!-- id:v9970is -->
