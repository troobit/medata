...
- [ ] 1. Make BUILD_STAMP dirty-aware in the Makefile <!-- id:bpv001a -->
...
- [ ] 2. Mirror the dirty-aware default into both deploy scripts <!-- id:bpv002b -->
...
- [ ] 4. Document the stamp format and the UI-attempt tag convention <!-- id:bpv004d -->
