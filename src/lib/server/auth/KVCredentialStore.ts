 ...
 * Uses KV TTL for automatic challenge expiry.
 */
...
export class KVCredentialStore implements ICredentialStore {
   ...
   * Returns undefined if challenge doesn't exist or has expired
   */
  async getChallenge(): Promise<StoredChallenge | undefined> {
    ...
    // Check if challenge has expired (belt-and-suspenders with KV TTL)
  ...
  /**
   * Store a challenge with TTL for auto-expiry
   */
